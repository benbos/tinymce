<ul>
	...
	<li><a id="m5" href="javascript:;" title="" onclick="SMImage_PageReload('<?php echo bin2hex(RC4("id=1&".$GET)) . '&time=' . time(); ?>'); if (window.event){ window.event.returnValue = false; }"><img src="img/icon_reload_24x24.png" border="0" /></a></li>
	<li><img class="separator" src="img/icon_separator.png" border="0" /></li>
